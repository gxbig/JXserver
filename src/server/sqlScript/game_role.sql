...
CREATE TABLE jxserver.`game_role` (
                                      ...
                                      `role_type` enum('soldier','master','shooter') NOT NULL COMMENT '角色类型 1、战士： ''soldier''2、 法师：''master''  3、射手：''shooter''',
                                      ...
                                      `spell_damage_grow_up` float NOT NULL DEFAULT '0' COMMENT '法术伤害每级增长率',
                                      `spell_defense` int NOT NULL DEFAULT '0' COMMENT '法术防御',
                                      `physical_defense` int NOT NULL DEFAULT '0' COMMENT '物理防御',
                                      `spell_defense_grow_up` float NOT NULL DEFAULT '0' COMMENT '法术防御增长率',
                                      `physical_defense_grow_up` float NOT NULL DEFAULT '0' COMMENT '物理防御增长率',
